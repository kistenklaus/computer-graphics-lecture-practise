...
{
	glm::mat4 camToWorld = glm::translate(glm::mat4(1.0), m_position[0]) * glm::rotate(glm::mat4(1.0), m_yaw, glm::vec3(0.0, 1.0, 0.0)) * glm::rotate(glm::mat4(1.0), m_pitch, glm::vec3(1.0, 0.0, 0.0));
