...
public:
    ...
    glm::vec2 uv = glm::vec2(0.0f);                   // uv texture coordinates at the intersection point
    glm::vec2 dudv = glm::vec2(0.0f);                 // side lengths of the pixel footprint's AABB in uv space (for mipmap filter)
